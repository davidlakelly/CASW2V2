...
class DependenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dependency" do
    assert_difference('Dependency.count') do
      post dependencies_url, params: { dependency: { author: @dependency.author, name: @dependency.name, version: @dependency.version } }
    end
  ...
  test "should update dependency" do
    patch dependency_url(@dependency), params: { dependency: { author: @dependency.author, name: @dependency.name, version: @dependency.version } }
